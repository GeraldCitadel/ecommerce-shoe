...
import remove_icon from '../Asset/Multiplication_sign.jpg'
import add_icon from '../Asset/Plus_sign.png'
            ...
            if (cartItems[e.id] > 0) {
               return <div key={i}>
                  <div className="cartitems-format cartitems-format-main">
                     ...
                     <p>{e.name}</p>
                     <p>N{e.new_price}</p>
                     <div> <button className="cartitems-quantity">{cartItems[e.id]}</button>
